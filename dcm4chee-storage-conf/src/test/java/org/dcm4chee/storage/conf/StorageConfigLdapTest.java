...
public class StorageConfigLdapTest extends StorageConfigTestBase{
    ...
    public void setUp() throws Exception {
        ...
        cfg.addDicomConfigurationExtension(new LdapGenericConfigExtension<StorageConfiguration>(StorageConfiguration.class));
        config = cfg;
    }
}
